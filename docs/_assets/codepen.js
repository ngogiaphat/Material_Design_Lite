...
/**
 * Extracts the parts of the text that is inside occurrences of the tag and endTag.
 ...
 * @param  {String} text The text for which we need to extract the content in the given tags
 * @return {Object} An Object with 2 attributes: textRemainder which contains the text not inside any of the given tag. and tagContent which contains a concatenation of what was inside the tags
 */
...
/**
 * Click handler for CodePen buttons. Prepares the content for CodePen and submits the form.
